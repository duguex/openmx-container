/**********************************************************************
  ...
  10/Sep./2022   Modified by Naoya Yamaguchi
...
int main(int argc, char *argv[]) 
{
  ...
  if (myrank==0){
    ...
    printf(" \n");
    printf(" Please cite the two following articles:\n");
    printf(" H. Kotaka, F. Ishii, M. Saito,\n");
    printf(" Jpn. J. Appl. Phys. 52, 035204 (2013).\n");
    printf(" DOI: 10.7567/JJAP.52.035204\n");
    printf(" \n");
    printf(" N. Yamaguchi, F. Ishii,\n");
    printf(" Appl. Phys. Express 10, 123003 (2017).\n");
    printf(" DOI: 10.7567/APEX.10.123003\n");
    printf("******************************************************************\n");
    printf("******************************************************************\n");
  }
  /* ***/
