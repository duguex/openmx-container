...
#else
	    fprintf(fp1,"%20.16f %20.16f ", MulP_Cc[0][l-l_min][j*(atomnum+1)+i], MulP_Cc[1][l-l_min][j*(atomnum+1)+i]);
	    fprintf(fp1,"%20.16f %20.16f ", MulP_Cc[2][l-l_min][j*(atomnum+1)+i], MulP_Cc[3][l-l_min][j*(atomnum+1)+i]);
#endif
	    /* ***/
	  } fprintf(fp1,"\n");
	}//j
...
#else
	      fprintf(fp1, "%20.16f %20.16f ", OrbMulP_Cc[0][i1][l-l_min][j*(atomnum+1)+i], OrbMulP_Cc[1][i1][l-l_min][j*(atomnum+1)+i]);
	      fprintf(fp1, "%20.16f %20.16f ", OrbMulP_Cc[2][i1][l-l_min][j*(atomnum+1)+i], OrbMulP_Cc[3][i1][l-l_min][j*(atomnum+1)+i]);
#endif
	      /* ***/
	    }
	    fprintf(fp1, "\n");
...
#else
	      fprintf(fp1, "%20.16f %20.16f ", Orb2MulP_Cc[0][i1][l-l_min][j*(atomnum+1)+i], Orb2MulP_Cc[1][i1][l-l_min][j*(atomnum+1)+i]);
	      fprintf(fp1, "%20.16f %20.16f ", Orb2MulP_Cc[2][i1][l-l_min][j*(atomnum+1)+i], Orb2MulP_Cc[3][i1][l-l_min][j*(atomnum+1)+i]);
#endif
	      /* ***/
	    }
	    fprintf(fp1, "\n");
