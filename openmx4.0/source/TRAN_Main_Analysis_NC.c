  ...
  for (GA_AN=1; GA_AN<=atomnum_e[iside]; GA_AN++){
	...
	for (i=0; i<tnoA; i++){
	  for (j=0; j<tnoB; j++){
	      ...
	      /* H_alpha-alpha */
	      H00_e[iside][S00_ref(Anum+i,Bnum+j)].r += co*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];
	      H00_e[iside][S00_ref(Anum+i,Bnum+j)].i += si*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];

	      /* H_beta-beta */
	      H00_e[iside][S11_ref(Anum+i,Bnum+j)].r += co*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];
	      H00_e[iside][S11_ref(Anum+i,Bnum+j)].i += si*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];
	    }
	...
	for (i=0; i<tnoA; i++){
	  for (j=0; j<tnoB; j++){
	      ...
	      /* H_alpha-alpha */
	      H01_e[iside][S00_ref(Anum+i,Bnum+j)].r += co*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];
	      H01_e[iside][S00_ref(Anum+i,Bnum+j)].i += si*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];

	      /* H_beta-beta */
	      H01_e[iside][S11_ref(Anum+i,Bnum+j)].r += co*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];
	      H01_e[iside][S11_ref(Anum+i,Bnum+j)].i += si*OLP_e[iside][0][GA_AN][LB_AN][i][j]*tran_biasvoltage_e[iside];
	    }
