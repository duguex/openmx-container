...
void SHG()
{
  ...
  double *eval,**omega_gg,sum0,sum1,sum2,w1,w2,w3,w4,Dmnb,Dmnc,Cell_Volume;
  ...
  *************************************************************/
	  ...
	  for (m=0; m<MatDim; m++){
		...
		if (m!=l && n!=l){
		  ...
		  tmp1 = (2.0*fnm/(wmn-2.0*omega) + fln/(wln-omega) + fml/(wml-omega))/(wln - wml);
                  ...
                  //printf("ABC1 kloop=%2d p=%2d n=%2d m=%2d l=%2d tmp1=%15.12f\n",kloop,p,n,m,l,tmp1);
  ...
  for (p=0; p<Ng; p++){
    ...
    printf("%15.12f %15.12f %15.12f\n",
           omega,chi_e[a][b][c][p].r+0.0*chi_i[a][b][c][p].r,chi_e[a][b][c][p].i+0.0*chi_i[a][b][c][p].i);
  }
