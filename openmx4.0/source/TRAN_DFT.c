...
static double TRAN_DFT_Original(
                ...
                double *****iCDM,  /* output, density matrix */
                double *****EDM,  /* not used */
                ...
                double ChemP_e0[2]) 
{
  ...
  *************************************************/
    ...
    *************************************************************/
	...
	for (j=0; j<Kspace_grid2; j++) {
	  for (k=0; k<Kspace_grid3; k++) {
		...
		ik=Kspace_grid3-k;
	      ...
	      if ( (i==0 || 2*i==Kspace_grid1) 
                && (j==0 || 2*j==Kspace_grid2) 
                && (k==0 || 2*k==Kspace_grid3)){
    ...
    /***************************************
        find T_knum and allocate arrays
    ***************************************/
    ...
    ***********************************************/
    ...
    time5 += Band_DFT_Col(1,
                          ...
                          SpinP_switch,0,H,iHNL,OLP[0],DM[0],EDM,Eele0,Eele1, 
