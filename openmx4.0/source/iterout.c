        ...
        if ( MD_switch==1 || 
          ...
          ***********************************************/
          ...
          fprintf(fp,"%4s   %8.5f %8.5f %8.5f  %8.5f %8.5f %8.5f %8.5f %8.5f %8.5f  %8.5f %8.5f %8.5f %8.5f\n",
                  Atom_Symbol[j],                                                     /* 1: */
	   	  Gxyz[k][1]*BohrR,Gxyz[k][2]*BohrR,Gxyz[k][3]*BohrR,                 /* 2,3,4: */ 
	         -Gxyz[k][17],-Gxyz[k][18],-Gxyz[k][19],                              /* 5,6,7: force */
		  Gxyz[k][24]/(0.4571028*0.000001),                                   /* 8: x-component of velocity */
                  Gxyz[k][25]/(0.4571028*0.000001),                                   /* 9: y-component of velocity */
                  Gxyz[k][26]/(0.4571028*0.000001),                                   /* 10: z-component of velocity */
                  Spe_Core_Charge[i]-(InitN_USpin[k]+InitN_DSpin[k]),                 /* 11: Net charge, electron charge is defined to be negative. */
                  InitN_USpin[k]-InitN_DSpin[k],                                      /* 12: magnetic moment (muB) */
                  angle0,angle1);                                                     /* 13,14: angles of spin */     
